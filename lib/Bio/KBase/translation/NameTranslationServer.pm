...
our %return_counts = (
        ...
        'get_scientific_names_by_name' => 1,
        'get_all_names_by_name' => 1,
        'get_scientific_name_by_tax_id' => 1,
        'get_tax_id_by_scientific_name' => 1,
        'get_tax_ids_by_name' => 1,
        'get_all_names_by_tax_id' => 1,
        'version' => 1,
);
...
sub call_method {
    ...
    my $ctx = NameTranslationServerContext->new(client_ip => $self->_plack_req->address);
    
    my $args = $data->{arguments};

        # Service NameTranslation does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service NameTranslation.");
    }
...
package NameTranslationServerContext;

use strict;

=head1 NAME

NameTranslationServerContext
